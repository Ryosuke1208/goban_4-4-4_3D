...
void showTitle(int *m, int *d, int *f) {
	...
	while (1) {
		...
		DrawStringToHandle(50, 560, "ﾌﾟﾚｲﾔｰが先行", BLACK, fontHandle3);
		DrawLineAA(400.0f, 540.0f, 400.0f, 630.0f, BLACK);
		DrawStringToHandle(450, 560, "ﾌﾟﾚｲﾔｰが後行", BLACK, fontHandle3);
		...
		DrawStringToHandle(275, 645, "ＳＴＡＲＴ", BLACK, fontHandle3);
		...
		DrawStringToHandle(220, 730, "ゲームをやめる", BLACK, fontHandle3);
